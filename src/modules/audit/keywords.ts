...
export const extractKeywords = ($: cheerio.CheerioAPI, targetKeyword?: string): { keywords: KeywordResult[], targetIssues: any[] } => {
    ...
    if (totalWords === 0) return { keywords: [], targetIssues };
